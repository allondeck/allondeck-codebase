  ...
  return (
    ...
    >
      ...
      <div className="relative w-56 md:w-64 lg:w-72 aspect-[3/4] shrink-0 md:-mb-16 lg:-mb-20 z-10">
        ...
        <div className="absolute bottom-4 -right-16 md:-right-24 w-44 md:w-56 pointer-events-none z-20" aria-hidden="true">
          <svg
      ...
      <div className="w-full text-center md:text-left flex-1">
        <h2 className="font-heading text-lg md:text-2xl xl:text-3xl font-bold tracking-widest leading-tight uppercase">
        ...
        <div className="mt-5 flex justify-center md:justify-start items-center gap-4">
          ...
          <a
            ...
            className="flex size-12 shrink-0 items-center justify-center transition-transform hover:scale-105 rounded-full focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-brand-orange"
          ...
          <a
            href={`mailto:${email}`}
            className="flex size-[42px] shrink-0 items-center justify-center rounded-2xl bg-brand-orange text-brand-navy hover:scale-105 transition-transform focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white"
