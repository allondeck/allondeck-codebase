...
import { useCastAndReel } from "../ui/CastAndReelSplash";
  ...
  return (
    ...
    >
      <Link
        ...
        className="group block h-full overflow-hidden rounded-3xl border border-brand-medium/30 bg-brand-dark-alt shadow-md transition-shadow hover:shadow-xl hover:border-brand-orange/40"
      >
        <div className="relative aspect-square overflow-hidden bg-brand-dark">
          ...
          {product.is_featured && (
            <span className="absolute left-2 top-2 rounded bg-brand-orange px-2 py-0.5 text-xs font-semibold text-white shadow-sm">
              Featured
            </span>
          )}
          <button
            ...
            className="absolute right-2 top-2 rounded-full bg-brand-dark-alt/95 p-1.5 shadow-sm transition hover:bg-brand-medium active:scale-90"
