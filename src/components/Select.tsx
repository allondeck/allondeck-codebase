...
const baseStyles =
  'w-full min-w-0 appearance-none rounded-lg border border-[#066175]/60 bg-[#044155] pl-4 pr-12 py-2 text-sm text-white focus:border-[#e38622] focus:outline-none focus:ring-1 focus:ring-[#e38622]'
