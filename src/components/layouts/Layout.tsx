      ...
      <footer className="mt-auto overflow-hidden font-sans">
        <div className="grid grid-cols-1 md:grid-cols-3 w-full">
          ...
          <div className="bg-brand-dark p-12 flex flex-col justify-start items-center text-center text-white">
            ...
            <svg className="w-16 h-3 text-brand-orange mt-3 mx-auto" viewBox="0 0 100 12" fill="none" stroke="currentColor" strokeWidth="3.2">
            ...
            <div className="mt-8 space-y-1.5 md:space-y-6 flex flex-col items-center md:items-start w-full">
              <div className="flex items-center gap-4 text-left">
                ...
                <div className="font-sans text-base font-semibold text-white space-y-1 flex flex-col">
                  <a href="tel:7865758870" className="hover:text-brand-orange transition-colors">
                    (786) 575 8870
                  </a>
                  <a href="tel:7865708343" className="hover:text-brand-orange transition-colors">
                    (786) 570 8343
                  </a>
                </div>
              </div>
              ...
              <div className="flex items-center gap-4 text-left">
                ...
                <a href="mailto:allondeckadm@gmail.com" className="font-sans text-base font-semibold text-white hover:text-brand-orange transition-colors">
              ...
              <div className="flex items-center gap-6 pt-4 text-left">
                <a href="https://www.facebook.com/all.on.deck.2023?mibextid=LQQJ4d" target="_blank" rel="noopener noreferrer" className="text-brand-cream hover:text-brand-orange transition-colors" aria-label="Facebook">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M22 12c0-5.52-4.48-10-10-10S2 6.48 2 12c0 4.84 3.44 8.87 8 9.8V15H8v-3h2V9.5C10 7.57 11.57 6 13.5 6H16v3h-2c-.55 0-1 .45-1 1v2h3v3h-3v6.95c5.05-.5 9-4.76 9-9.95z"/>
                  </svg>
                </a>
                <a href="https://www.instagram.com/all_ondeck?igsh=dHM0Y2J4ZnJqMWd3&utm_source=qr" target="_blank" rel="noopener noreferrer" className="text-brand-cream hover:text-brand-orange transition-colors" aria-label="Instagram">
                  <svg className="w-8 h-8" fill="currentColor" viewBox="0 0 24 24">
          ...
          <div className="bg-brand-medium p-12 flex flex-col justify-start items-center text-center text-white">
            ...
            <div className="mt-8 space-y-1.5 md:space-y-6 w-full max-w-xs flex flex-col items-center md:items-start">
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <h4 className="font-heading text-sm font-black tracking-wider text-brand-cream">
                    <a href="https://maps.google.com/?q=Miami,+FL" target="_blank" rel="noopener noreferrer" className="hover:text-brand-orange transition-colors">
                      Miami, FL
                    </a>
                  </h4>
                </div>
              ...
              <div className="flex items-center gap-4 text-left">
                ...
                <div>
                  <h4 className="font-heading text-sm font-black tracking-wider text-brand-cream">
                    <a href="https://maps.google.com/?q=Orlando,+FL" target="_blank" rel="noopener noreferrer" className="hover:text-brand-orange transition-colors">
                      Orlando, FL
                    </a>
                  </h4>
                </div>
