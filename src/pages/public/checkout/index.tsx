...
import { GuestEmailSection } from "./partials/GuestEmailSection";
import { ShippingAddressSection } from "./partials/ShippingAddressSection";
import { CouponSection } from "./partials/CouponSection";
import { CheckoutSummarySection } from "./partials/CheckoutSummarySection";
  ...
  return (
    <div className="mx-auto max-w-content px-6 lg:px-12 py-16 sm:px-6 text-left">
      ...
      <form onSubmit={handlePlaceOrder}>
        {!user && (
          <GuestEmailSection guestEmail={guestEmail} onChange={setGuestEmail} />
        )}
