    ...
    <div className="bg-brand-dark text-white font-sans">
          ...
          <div className="flex flex-col items-center text-center w-full max-w-[280px]">
            ...
            <div className="relative w-full aspect-[3/4] rounded-[2rem] overflow-hidden border border-brand-medium/35 bg-brand-dark-alt shadow-xl">
              ...
              <div className="absolute -bottom-2 -left-2 w-28 pointer-events-none z-20">
                <svg viewBox="0 0 380.442 62.684" className="w-full h-auto text-brand-light" fill="currentColor">
            ...
            <div className="mt-4 w-full">
              ...
              <div className="mt-4 flex items-center justify-center gap-3">
                <button
                  ...
                  className="px-5 py-2.5 rounded-2xl bg-brand-cream text-[#05586d] text-xs font-bold uppercase tracking-wider hover:bg-white hover:scale-105 transition-all shadow-md"
                >
                  View Bio
                </button>
                <a
            ...
            <div className="mt-4 w-full">
              ...
              <div className="mt-4 flex items-center justify-center gap-3">
                <button
                  ...
                  className="px-5 py-2.5 rounded-2xl bg-brand-orange text-brand-cream text-xs font-bold uppercase tracking-wider hover:bg-orange-600 hover:scale-105 transition-all shadow-md"
                >
                  View Bio
                </button>
                <a
      ...
      <div className="mx-auto max-w-[900px] px-6 lg:px-12 pb-24">
        <div className="flex flex-col gap-36 md:gap-32">
          ...
          <div id="ernesto-bio" className="relative mt-20 md:mt-0 bg-[#05586d] rounded-[2rem] border border-brand-medium/35 px-6 py-8 md:py-6 md:pl-0 md:pr-12 flex flex-col md:flex-row items-center gap-6 md:gap-10 shadow-lg text-white">
            ...
            <div className="w-full text-center md:text-left flex-1">
              <h3 className="font-heading text-lg md:text-xl font-bold tracking-widest leading-tight uppercase">
                ...
                <span className="text-brand-cream">Ernesto Alvarez</span>
              </h3>
              ...
              <div className="mt-5 flex justify-center md:justify-start items-center gap-4">
                ...
                <a
                  href="mailto:ernesto@allondeck.com"
                  className="flex h-12 w-12 items-center justify-center rounded-2xl bg-brand-orange text-[#05586d] hover:bg-[#d2751b] transition-all hover:scale-105 shadow-md"
                  aria-label="Email"
                >
          ...
          <div id="roselena-bio" className="relative mt-20 md:mt-0 bg-[#05586d] rounded-[2rem] border border-brand-medium/35 px-6 py-8 md:py-6 md:pl-0 md:pr-12 flex flex-col md:flex-row items-center gap-6 md:gap-10 shadow-lg text-white">
            ...
            <div className="w-full text-center md:text-left flex-1">
              <h3 className="font-heading text-lg md:text-xl font-bold tracking-widest leading-tight uppercase">
                ...
                <span className="text-brand-cream">Roselena Oropesa</span>
              </h3>
              <p className="mt-3 text-sm md:text-base leading-relaxed text-white/90 font-sans">
