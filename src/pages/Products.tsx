        ...
        {showInStockFilter && (
          <label className="flex cursor-pointer items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#066175]/50 bg-[#052631] text-[#e38622] focus:ring-[#e38622] focus:ring-offset-[#044155]"
            />
            <span className="text-sm text-[#f6ebd4]">In stock only</span>
          </label>
        )}
        {showSaleFilter && (
          <label className="flex cursor-pointer items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#066175]/50 bg-[#052631] text-[#e38622] focus:ring-[#e38622] focus:ring-offset-[#044155]"
            />
            <span className="text-sm text-[#f6ebd4]">On sale</span>
          </label>
        )}
        {showFeaturedFilter && (
          <label className="flex cursor-pointer items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#066175]/50 bg-[#052631] text-[#e38622] focus:ring-[#e38622] focus:ring-offset-[#044155]"
            />
            <span className="text-sm text-[#f6ebd4]">Featured only</span>
          </label>
        )}
        {showNewArrivalsFilter && (
          <label className="flex cursor-pointer items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#066175]/50 bg-[#052631] text-[#e38622] focus:ring-[#e38622] focus:ring-offset-[#044155]"
            />
            <span className="text-sm text-[#f6ebd4]">
        ...
        {showLowStockFilter && (
          <label className="flex cursor-pointer items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#066175]/50 bg-[#052631] text-[#e38622] focus:ring-[#e38622] focus:ring-offset-[#044155]"
            />
            <span className="text-sm text-[#f6ebd4]">Low stock</span>
          </label>
        )}
        {showDealsFilter && (
          <label className="flex cursor-pointer items-center gap-2">
            <input
              ...
              className="h-4 w-4 rounded border-[#066175]/50 bg-[#052631] text-[#e38622] focus:ring-[#e38622] focus:ring-offset-[#044155]"
            />
            <span className="text-sm text-[#f6ebd4]">Deals</span>
          </label>
        )}
      </div>
      {activeFilterCount > 0 && (
        <button
          ...
          className="mt-4 w-full rounded-lg border border-[#066175]/50 bg-[#052631] px-3 py-2 text-sm font-medium text-[#f6ebd4] hover:bg-[#066175]/30"
        >
          Clear filters
        </button>
      )}
    ...
    <div className="mx-auto max-w-[1400px] px-6 lg:px-12 py-8 sm:px-6 lg:px-8 w-full">
      <div className="flex flex-col gap-6 md:flex-row md:gap-8">
        ...
        <div className="flex flex-col gap-3 md:hidden">
          <div>
            <label
              ...
              className="mb-2 block text-sm font-medium text-[#f6ebd4]"
            >
              Category
            </label>
            <Select
          ...
          {hasAnyFilter && (
            <div>
              <button
                ...
                className="flex w-full items-center justify-between rounded-lg border border-[#066175]/50 bg-[#052631] px-4 py-2.5 text-sm font-medium text-[#f6ebd4] hover:bg-[#066175]/30"
              >
                <span>Filters</span>
                {activeFilterCount > 0 ? (
                  <span className="rounded-full bg-[#e38622] px-2 py-0.5 text-xs text-white">
                    {activeFilterCount}
                  </span>
                ) : null}
              </button>
              {mobileFiltersOpen && (
                <div className="mt-2 rounded-lg border border-[#066175]/35 bg-[#052631] p-4">
                  {filtersContent}
                </div>
              )}
            </div>
        ...
        <aside className="hidden w-64 shrink-0 md:block">
          <div className="border-b border-[#066175]/35 pb-4">
            <button
              type="button"
              onClick={() => setCategoriesCollapsed((c) => !c)}
              className="flex w-full items-center justify-between rounded-lg py-1 text-left font-semibold text-white hover:bg-[#066175]/30"
              ...
              <nav className="mt-2 space-y-1">
                <Link
                  ...
                  className={`block rounded-lg px-3 py-2 text-sm ${
                    !categorySlug
                      ? "bg-[#066175]/30 font-medium text-[#e38622]"
                      : "text-[#f6ebd4] hover:bg-[#066175]/30 hover:text-white"
                  }`}
                >
                  All
                </Link>
          ...
          {hasAnyFilter && (
            <div className="mt-4 pt-4">
              <button
                ...
                className="flex w-full items-center gap-2 rounded-lg py-1 text-left font-semibold text-white hover:bg-[#066175]/30"
              ...
              >
                ...
                <svg
                  className={`ml-auto h-5 w-5 shrink-0 text-[#76abbf] transition-transform ${
        ...
        <div className="min-w-0 flex-1">
          <div className="mb-6 flex flex-col gap-3 sm:flex-row sm:items-center sm:justify-between sm:gap-4">
            <div className="min-w-0 flex-1">
              <input
                ...
                className="w-full rounded-lg border border-[#066175]/50 bg-[#052631] px-4 py-2 text-white placeholder-[#76abbf]/50 focus:border-[#e38622] focus:outline-none focus:ring-1 focus:ring-[#e38622]"
              />
            </div>
            <Select
              value={sortParam}
            ...
            <div className="mb-4 flex flex-wrap items-center gap-2">
              {showPriceFilter &&
                (priceMin !== priceFloor || priceMax !== priceCeil) && (
                  <span className="inline-flex items-center gap-1 rounded-full bg-[#066175]/30 px-3 py-1 text-sm text-[#f6ebd4]">
                    ...
                    <button
                      ...
                      className="ml-1 rounded-full p-0.5 hover:bg-[#066175]/50"
          ...
          {!loading && !error && products.length === 0 && (
            <p className="text-[#76abbf]">No products found.</p>
          )}
          {!loading && !error && products.length > 0 && (
          ...
          {showSuggested && (
            <section className="mt-12 border-t border-[#066175]/35 pt-8">
