  ...
  if (itemCount === 0) {
    return (
      <div className="rounded-xl border border-[#066175]/35 bg-[#052631] p-12 text-center">
        ...
        <p className="mt-2 text-[#76abbf]">Add products to your cart first.</p>
        <Link
          to="/products"
  ...
  return (
    <div className="mx-auto max-w-[1400px] px-6 lg:px-12 py-16 sm:px-6 lg:px-8 text-left">
      ...
      <form onSubmit={handlePlaceOrder}>
        {!user && (
          <div className="mb-6 rounded-lg border border-[#066175]/35 bg-[#052631] p-6">
            <label
              htmlFor="guestEmail"
          ...
          <div className="space-y-4">
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-[#f6ebd4]"
              >
                Address line 2 <span className="text-[#76abbf]/60">(optional)</span>
              </label>
              <input
                id="line2"
                type="text"
            ...
            <div>
              <label
                ...
                className="block text-sm font-medium text-[#f6ebd4]"
              >
                Phone <span className="text-[#76abbf]/60">(optional)</span>
              </label>
              <input
                id="phone"
                type="tel"
          ...
          {couponResult?.ok ? (
            ...
            <div className="flex gap-2">
              <input
                ...
                className="flex-1 rounded-lg border border-[#066175]/50 bg-[#044155] px-3 py-2 font-mono uppercase text-white placeholder-[#76abbf]/50 focus:border-[#e38622] focus:outline-none focus:ring-1 focus:ring-[#e38622]"
              />
              <Button
                type="button"
                variant="secondary"
        ...
        <div className="rounded-lg border border-[#066175]/35 bg-[#052631] p-6">
          ...
          <ul className="mt-4 space-y-2">
            {items.map((item, idx) =>
              isProductCartItem(item) ? (
                <li
                  key={item.product.id}
                  className="flex justify-between text-[#f6ebd4]"
                >
                  <span>
          ...
          <div className="mt-4 space-y-1 border-t border-[#066175]/35 pt-4">
          ...
          {estimatedDelivery && (
            <p className="mt-3 text-sm text-[#76abbf]">
        ...
        <div className="mt-6 flex gap-4">
          <Link
            to="/cart"
            className="inline-flex items-center rounded-lg border border-[#066175]/50 bg-[#052631] px-6 py-3 font-medium text-[#f6ebd4] hover:bg-[#066175]/30 transition-all duration-200 hover:scale-105 active:scale-95"
          >
            Back to Cart
          </Link>
