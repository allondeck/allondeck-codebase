  ...
  return (
    <div className="mx-auto max-w-[1400px] px-6 lg:px-12 py-8 sm:px-6 lg:px-8 w-full text-left">
      ...
      <form
        ...
        className="mt-6 space-y-4 rounded-lg border border-brand-medium/35 bg-brand-dark-alt p-6"
      >
        <div>
          <label
          ...
          <input
            ...
            className="mt-1 w-full rounded-lg border border-brand-medium/50 bg-brand-dark px-3 py-2 text-white placeholder-brand-light/50 focus:border-brand-orange focus:outline-none focus:ring-1 focus:ring-brand-orange font-mono text-sm"
          />
        </div>
        <div>
          <label
              ...
              <div className="mt-4 border-t border-brand-medium/35 pt-4">
                ...
                {getTrackingUrl(order.carrier, order.tracking_number) ? (
                  ...
                  <button
                    ...
                    className="mt-2 text-sm font-medium text-brand-light hover:text-white"
                  >
          ...
          <div className="rounded-lg border border-brand-medium/35 bg-brand-dark-alt p-6">
            ...
            <ul className="mt-4 space-y-3">
              {items.map((item, i) => (
                <li
                  key={i}
                  className="flex justify-between border-b border-brand-medium/35 pb-3 last:border-0"
                >
            ...
            <div className="mt-4 border-t border-brand-medium/35 pt-4">
              <div className="flex justify-between text-sm text-brand-cream">
                <span>Subtotal</span>
      ...
      <p className="mt-6 text-center text-sm text-brand-light">
        <Link to="/" className="text-brand-light hover:text-white">
          Back to store
        </Link>
      </p>
    </div>
