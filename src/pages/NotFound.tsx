...
export default function NotFound() {
  ...
  return (
    <div
      className="flex flex-col items-center justify-center bg-[#052631] font-sans text-white overflow-hidden relative cursor-crosshair min-h-[calc(100vh-100px)] lg:min-h-[calc(100vh-150px)]"
    ...
    >
      ...
      <div className="relative z-10 text-center pointer-events-none p-6">
        ...
        <p className="mt-6 text-lg text-[#f6ebd4] max-w-sm mx-auto font-medium">
        ...
        <div className="mt-12 pointer-events-auto">
          <Link
            to="/"
            className="inline-block rounded-full bg-[#e38622] px-8 py-3 text-xs font-bold uppercase tracking-wider text-white transition-transform hover:scale-105 shadow-lg shadow-[#e38622]/20"
          >
            Back to home
          </Link>
        </div>
